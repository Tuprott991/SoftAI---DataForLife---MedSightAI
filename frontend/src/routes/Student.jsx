...
export const Student = () => {
    ...
    // Fetch patients data (hide patient info for students)
    useEffect(() => {
        const fetchPatients = async () => {
            ...
            try {
                ...
                // Remove sensitive patient information for students
                const anonymizedPatients = (data.patients || []).map(patient => ({
                    ...patient,
                    name: `Case ${patient.id.substring(0, 8)}`, // Anonymize name
                    age: null, // Hide age
                    gender: null, // Hide gender
                    history: null, // Hide history
                    blood_type: null, // Hide blood type
                    underlying_condition: null, // Hide underlying conditions
                }));
            ...
            <div className="container mx-auto px-6 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold">{t('student.title')}</h1>
                    </div>
                    ...
                    <>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {patients.map((patient) => (
                                <PatientCard key={patient.id} patient={patient} isStudentView={true} />
                            ))}
                        </div>
